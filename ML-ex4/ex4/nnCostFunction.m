...
% 1st sum row-wise then column-wise
J = sum(sum(-(y_matrix.*log(h_theta)) - (1-y_matrix).*(log(1-h_theta)),2))/m;
...
% Not applying regularization in first column of Theta1_grad as it contains the bias terms
